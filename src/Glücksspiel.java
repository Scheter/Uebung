...
public class Glücksspiel {
	...
	static String name2 = "Thomas";     //gangnamstyle whopwhop
	...
	public static void main(String[] args) {
		...
		begruessung(alter1,geschlecht1,name1);
		begruessung(alter2,geschlecht2,name2);
		auswertung();
			
		
	}
	
	public static void begruessung(int alter, boolean geschlecht, String name){
